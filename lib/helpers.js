(function (root, factory) {
    ...
    /**
     Augments the reciever with the properties of the sender at the first
     level. Mutable values within the sender are passed directly. This is used
     to avoid manipulating options.hash
     @method extend
     @param {Object} reciever
     @param {Object} sender
     @return {Object} augmented reciever
     */
