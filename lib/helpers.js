(function (root, factory) {
    ...
    if (root) {
        ...
        // If we find `Handlebars` in the global namespace then go ahead and
        // register ourself to it.
        if (root.Handlebars && typeof root.Handlebars.registerHelper === 'function') {
            lib.register(root.Handlebars);
        }
    }
