(function (root, factory) /* istanbul ignore next */{
    ...
    /**
     ...
     @return Locale
     */
    function _getCurrency (hash, ctx) {
        return (hash && hash.currency) ||
               (ctx  && ctx.currency)  ||
               defaults.currency;
    }
    ...
    function intlBlock (options) {
        ...
        if (hash.currency) {
            context.currency = _getCurrency(hash, this);
        }
    ...
    */
    function intlMessage (str, options) {
        ...
        if (!formatOptions.currency) {
            formatOptions.currency = _getCurrency(hash, this);
        }
    ...
    */
    ...
    return {
        ...
        setDefault: function (key/*obj*/, val) {
